...
Function GetJRE
    IfFileExists "jre-6u12-windows-i586-p-s.exe" lbl_NoDownloadRequired lbl_DownloadRequired
	
    lbl_NoDownloadRequired:
      ExecWait jre-6u12-windows-i586-p-s.exe
      GoTo done
	...
	StrCpy $2 "$TEMP\jre-6u12-windows-i586-p-s.exe"
