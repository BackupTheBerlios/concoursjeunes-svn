...
ALTER TABLE ENTITE ADD PAYS VARCHAR(2) BEFORE NOTEENTITE;
...
CREATE INDEX IF NOT EXISTS I_VILLE_UPPER_NOM ON VILLE (UPPER_NOM ASC);
...
-- Réglement: Ajout d'une description
ALTER TABLE REGLEMENT ADD DESCRIPTION VARCHAR(255);
