...
UPDATE CONTACT SET ID_ENTITE = (SELECT ID_ENTITE FROM ENTITE INNER JOIN ARCHERS ON ENTITE.AGREMENTENTITE=ARCHERS.AGREMENTENTITE WHERE ARCHERS.ID_CONTACT=CONTACT.ID_CONTACT);
