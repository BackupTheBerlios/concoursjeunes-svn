...
INSERT INTO DBPARAM (VERSION) VALUES (1);
...
CREATE TRIGGER DELETE_A_FFTA AFTER INSERT,UPDATE ON ARCHERS FOR EACH ROW CALL "org.concoursjeunes.triggers.DeleteArchersTrigger";
