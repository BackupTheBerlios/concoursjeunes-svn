...
CREATE TABLE ASSOCIER (
		NUMDISTANCESBLASONS INTEGER NOT NULL,
		NUMCRITERIASET INTEGER NOT NULL,
		PRIMARY KEY (NUMDISTANCESBLASONS, NUMCRITERIASET),
		FOREIGN KEY (NUMDISTANCESBLASONS) REFERENCES DISTANCESBLASONS (NUMDISTANCESBLASONS) ON UPDATE CASCADE ON DELETE CASCADE,
...
CREATE TABLE DISTINGUER (
		NUMLICENCEARCHER VARCHAR(7) NOT NULL,
		NUMCRITERIASET INTEGER NOT NULL,
		PRIMARY KEY (NUMLICENCEARCHER, NUMCRITERIASET),
