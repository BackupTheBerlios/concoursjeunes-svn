...
public class AppInfos {
	 ...
	 */
	public static final String VERSION = new String("2.19.00 - 07/03/2009");//$NON-NLS-1$
	
	/**
	 * Nom de code de l'application
	 */
	public static final String CODENAME = "On My Way"; //$NON-NLS-1$
	 ...
	 */
	public static final String COPYR = "© 2002-2009"; //$NON-NLS-1$
} 