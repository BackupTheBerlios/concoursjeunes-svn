...
public class DistancesEtBlason {
    ...
    public static DistancesEtBlason getDistancesEtBlasonForConcurrent(Reglement reglement, Concurrent concurrent) {
    	if(ConcoursJeunes.configuration != null) {
	    	CriteriaSet dti = concurrent.getCriteriaSet();
			dti.setFiltreCriteria(reglement.getPlacementFilter());
			return reglement.getCorrespondanceCriteriaSet_DB(dti);
    	}
    	return null;
    }
