...
public class FicheLoaderDialog extends JDialog implements ActionListener {
	...
	/**
	 * Création de la boite de dialogue de selection d'un concours à chargé
	 * 
	 * @param frame - la fenetre principal de l'application
	 * @param listFicheConcours - les titres de toutes les fiches concours
	 * @param selectedIndex - la fiche sélectionné courante
	 */
	public FicheLoaderDialog(JFrame frame, String[] listFicheConcours, int selectedIndex) {
		super(frame, ConcoursJeunes.ajrLibelle.getResourceString("ficheloader.titre"), true); //$NON-NLS-1$
	...
	public void initDialog() {
		...
		jbNouveau = new JButton(ConcoursJeunes.ajrLibelle.getResourceString("bouton.nouveau")); //$NON-NLS-1$
		jbOuvrir = new JButton(ConcoursJeunes.ajrLibelle.getResourceString("bouton.ouvrir")); //$NON-NLS-1$
		jbSupprimer = new JButton(ConcoursJeunes.ajrLibelle.getResourceString("bouton.supprimer")); //$NON-NLS-1$
	 ...
	 * @uml.property  name="listFicheConcours"
	 */
