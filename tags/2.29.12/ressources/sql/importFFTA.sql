...
UPDATE IMPORTFFTA.RESULT_CLUB SET ID_ENTITE = IFNULL((SELECT ID_ENTITE FROM ENTITE WHERE ENTITE.AGREMENTENTITE=IMPORTFFTA.RESULT_CLUB.AGRÉMENT AND ENTITE.NUMFEDERATION=2), ID_ENTITE);
MERGE INTO Entite (ID_ENTITE, AGREMENTENTITE, NUMFEDERATION, NOMENTITE, VILLEENTITE, TYPEENTITE, DATEMODIF) 
    SELECT distinct ID_ENTITE, "AGRÉMENT",2,"DÉSIGNATION","LOCALITÉ",3, @DATE_MODIF
